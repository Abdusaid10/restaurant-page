const contact = () => {
  ...
  let logoRestNameWrapper = document.createElement("DIV");
  ...
  let restoraName = document.createElement("img");
  ...
  let shareLinksBlock = document.createElement("DIV");
  shareLinksBlock.classList.add("share-block");

  let shareHeading = document.createElement("h4");
